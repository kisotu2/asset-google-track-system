...
printers = [
    ...
    ("2nd Floor", None, "10.4.0.18")  # Name is missing
]

# Insert printers into database
cursor.executemany('INSERT INTO printers (floor, name, ip) VALUES (?, ?, ?)', printers)

# Commit and close
conn.commit()
conn.close()

print("Database created and printers inserted successfully!")
